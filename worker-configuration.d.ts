/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ff7431acc94ce61d88c2fecd96e005a2)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_Env {
	AUTHA_DB: D1Database;
	APP_DB: D1Database;
	TOQUE_WORKER_URL: "https://toque.decloud.workers.dev";
	WORKER_URL: string;
	WORKER_API_TOKEN: string;
	AUTHA_PROXY_URL: string;
	SYSTEM_USER_ID: string;
	ACTIVE_ENTITY_ID: string;
	ACTIVE_ENTITY_TYPE_ID: string;
	AUTH_PATH: string;
	CAPTCHA_PATH: string;
	ENTITY_CONFIG_PATH: string;
	CAPTCHA_TOKEN: string;
	MASAR_POST_BODY: string;
	MASAR_POST_HEADERS: string;
	TOQUE_CONTAINER: DurableObjectNamespace<import("./src/index").ToqueContainer>;
	AUTHA_WORKER: Fetcher /* autha-worker */;
	APP_WORKER: Fetcher /* app-worker */;
	MCP_SERVER: Fetcher /* toque-mcp-server */;
	VISA_SCHEDULE_WORKFLOW: Workflow<Parameters<import("./src/index").VisaScheduleWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ToqueContainer";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TOQUE_WORKER_URL" | "WORKER_URL" | "WORKER_API_TOKEN" | "AUTHA_PROXY_URL" | "SYSTEM_USER_ID" | "ACTIVE_ENTITY_ID" | "ACTIVE_ENTITY_TYPE_ID" | "AUTH_PATH" | "CAPTCHA_PATH" | "ENTITY_CONFIG_PATH" | "CAPTCHA_TOKEN" | "MASAR_POST_BODY" | "MASAR_POST_HEADERS">> {}
}
